...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        {/* TOP WORD: KAMALDEEP (solid) — untouched, no overlap here */}
        <motion.div
        ...
        >
          <h1
            style={{
              fontSize: "clamp(4.2rem, 15vw, 13.5rem)",
              fontWeight: 900,
        ...
        {/* BOTTOM WORD: PRAJAPATI (outline) — photo pinned to the J / A boundary */}
        <motion.div
          style={{
            x: textMoveX,
            y: textMoveY,
        ...
        >
          ...
          >
            <span ref={partRef} style={{ marginRight: "100px" }}>PRAJ</span>
            <span>APATI</span>
          </h2>

          {/* Portrait, horizontally pinned to the measured J/A split so it always
              sits between those two letters, whatever the viewport width. */}
          <motion.div
            style={{
              x: photoMoveX,
              y: photoMoveY,
        ...
        {/* Caption, directly under the headline like Bazil's "based in..." line */}
        {/* <motion.p
        ...
        >
          Business Head, IREED India — based in New Delhi, India.
        </motion.p> */}
        ...
        {/* Social icons, tucked directly under "You need an advisor" */}
        <motion.div
